import 'package:th.ac.ru.uSmart/design_course/category_list_view.dart';
import 'package:th.ac.ru.uSmart/design_course/course_info_screen.dart';
import 'package:th.ac.ru.uSmart/design_course/popular_course_list_view.dart';
...
class _HomeScreenState extends State<HomeScreen> {
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: Text('${mr30.length}', style: TextStyle()),
                      ),
                    ),
                  ),
                ),
                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: Icon(Icons.clear_rounded,
                            color: Color.fromARGB(59, 63, 62, 62)),
                      ),
                    ),
                  ),
                ),
  ...
  Widget getPopularCourseUI() {
    ...
    print('isLoading ${mr30prov.isLoading}');
    return Padding(
      padding: const EdgeInsets.only(top: 8.0, left: 18, right: 16),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
