...
import 'package:th.ac.ru.uSmart/providers/rotcs_change_notifier.dart';
...
class RotcsRegisterPage extends StatefulWidget {
  const RotcsRegisterPage({super.key});

  @override
  State<RotcsRegisterPage> createState() => _RotcsRegisterPageState();
}

class _RotcsRegisterPageState extends State<RotcsRegisterPage>
  ...
  void _onRefresh() async {
    ...
    Future.microtask(
      () => context.read<RotcsChangeNotifier>().getAllRegister(),
    );
  ...
  Widget build(BuildContext context) {
    return Theme(
      ...
      child: Container(
        child: Scaffold(
          body: Consumer<RotcsChangeNotifier>(
  ...
  Widget getFilterBarUI(RotcsChangeNotifier rotcs) {
    return Stack(
      children: <Widget>[
        Positioned(
          top: 0,
  ...
  Widget getListUI() {
    var rotcs = context.watch<RotcsChangeNotifier>();
    return rotcs.isLoading
