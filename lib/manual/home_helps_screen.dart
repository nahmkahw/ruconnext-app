...
class HomeHelpsScreen extends StatefulWidget {
  const HomeHelpsScreen({super.key});

  @override
  State<HomeHelpsScreen> createState() => _HomeHelpsScreenState();
}

class _HomeHelpsScreenState extends State<HomeHelpsScreen> {
  int _currentIndex = 0;
