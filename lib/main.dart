...
import 'package:th.ac.ru.uSmart/services/schedule_service.dart';
    ...
    return MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider<MR30Provider>(
              create: (_) => MR30Provider(service: MR30Service())),
          ...
          ChangeNotifierProvider<ScheduleProvider>(
              create: (_) => ScheduleProvider(service: ScheduleService())),
...
//       ),
        child: GetMaterialApp(
          ...
          getPages: [
            ...
            GetPage(name: '/affair', page: () => AffairHomeScreen()),
