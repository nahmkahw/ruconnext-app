...
import 'package:th.ac.ru.uSmart/utils/button.dart';
...
class TodayPage extends StatefulWidget {
  ...
  const TodayPage({Key? key, required this.todayData}) : super(key: key);
                          ...
                          child: Stack(
                            ...
                            children: [
                              ...
                              Positioned(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    var mr30 = Provider.of<MR30Provider>(
                                        context,
                                        listen: false);

                                    mr30.addMR30(widget.todayData);

                                    Fluttertoast.showToast(
                                        msg:
                                            "Added to Favorite ${mr30.mr30record.length}");
                                  },
                                  child: Container(
                                    width: 70,
                                    height: 70,
