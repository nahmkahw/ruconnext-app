...
import 'package:th.ac.ru.uSmart/exceptions/dioexception.dart';
...
class MR30Service {
  ...
  Future<MR30> getMR30Pagination(int limit, offset) async {
    print('Service: getMR30Pagination');
    MR30YEAR mr30data = MR30YEAR.fromJson({});
    MR30 mr30list = MR30.fromJson({});
    try {
      var params = {};
      var response1 = await dioapi.api.post(
        '$mr30url/mr30/year',
        options: Options(
          headers: {
            HttpHeaders.contentTypeHeader: "application/json",
      ...
      if (response1.statusCode == 200) {
        // API call successful, parse the response data
        // Call API Response 2
        ...
        try {
          ...
          if (response2.statusCode == 200) {
            ...
            throw ('Error API2 call returned an error');
          }
        ...
        // API call returned an error
        throw ('Error API1 call returned an error');
      }
    } on DioError catch (err) {
      final errorMessage = DioException.fromDioError(err).toString();
      //print('Error Authentication Ramkhamhaeng University: $errorMessage .');
  ...
  Future<MR30> getAllMR30() async {
    MR30YEAR mr30data = MR30YEAR.fromJson({});
    MR30 mr30list = MR30(courseYear: '', courseSemester: '', rECORD: []);
    try {
      var params = {};
